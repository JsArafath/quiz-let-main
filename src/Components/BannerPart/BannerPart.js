...
const Banner = () => {
    return (
        <div className='banner-bg flex  justify-around items-center mx-auto lg:flex-row md:flex-col sm:flex-col flex-col-reverse'>
            ...
            <div>
                <img src={bannerImg} alt="" className='w-80 mx-20 mt-10 mb-20  '/>
            </div>
        </div>
    );
};
